...
- Reply: "Меню" — показывает количество доступных раскладов и статус карты дня, "Получить расклад" — открывает выбор действия.
...
- После расклада дня появляются кнопки: "Уточняющий вопрос 10💎" (опционально списывает алмазики при уточнении) и "Меню".
- В меню есть кнопка "🎁 Подарок" (ежедневный бонус) и "Профиль" (данные пользователя).
...
- Кнопка "🎁 Подарок" доступна раз в 24 часа и использует слот-кубик Telegram: выпадение даёт 5/15/30 алмазиков в зависимости от результата.
